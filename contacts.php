  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link navbar-brand" href="http://localhost/projet%20Examen/views/contacts/list_contact.php?user=etudiant">Liste des contacts<span class="sr-only"></span></a>
      </li>  
    </ul>
  </div>
</nav>
...
<div class="space"> </div>
    ...
    <div class="space"> </div>
    <h1 class="ligne">POUR PLUS DE DETAILS, CONTACTEZ-NOUS !!!</h1>
    </div>
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link navbar-brand" href="http://localhost/projet%20Examen/views/contacts/list_contact.php?user=prof">Liste des contacts<span class="sr-only"></span></a>
      </li>  
    </ul>
  </div>
</nav>
