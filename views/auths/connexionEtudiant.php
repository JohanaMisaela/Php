...
<body>
    ...
    <div id="container">
        ...
        <div id="content">
            <form action="connexionEtudiant.php" method="post" style="width:70%; margin-left:15%;text-align:center">
            ...
            <div class="form-group">
             <button style="text-align:center" type="submit" class="btn btn-info">Se connecter</button>
                ...
                <div id="space_down" style="text-align: center;margin-top: 10px"><h4>Pas encore de compte?  <a id="lien_inscription" href="inscriptionEtudiant.php"> Créez-en un !!</a></h4></div>
