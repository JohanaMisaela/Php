...
<?php $save_ajout = $object_auths -> saveProf(); ?>
...
<body>
    <div id="container">
        ...
        <h1 class="titre">S'inscrire(Prof)</h1>
        <div id="content">
        ...
        <div class="form-group" >
          <input style="text-align:center" type="text" name="matiere" placeholder="Matière enseignée" id="nom" class="form-control" required>
        </div>
        <div class="form-group" >
          <input style="text-align:center" type="text" name="niveau" placeholder="Niveau enseigné" id="nom" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <h4>Vous avez déjà un compte ?<a id="lien_connexion" href="connexionProf.php"> Cliquer ici pour vous connecter</a></h4>
      </form>
