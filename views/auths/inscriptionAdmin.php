...
<body>
    <div id="container">
        ...
        <div class="form-group" >
          <input style="text-align:center" type="text" name="telephone" placeholder="Votre Telephone" id="nom" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <h4>Vous avez déjà un compte ?<a id="lien_connexion" href="connexionAdmin.php"> Cliquer ici pour vous connecter</a></h4>
      </form>
